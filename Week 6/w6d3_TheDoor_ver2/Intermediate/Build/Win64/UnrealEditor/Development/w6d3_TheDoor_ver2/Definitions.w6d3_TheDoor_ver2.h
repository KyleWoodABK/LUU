...
#define UE_PROJECT_NAME w6d3_TheDoor_ver2
#define UE_TARGET_NAME w6d3_TheDoor_ver2Editor
#define UE_MODULE_NAME "w6d3_TheDoor_ver2"
...
#define W6D3_THEDOOR_VER2_API DLLEXPORT
