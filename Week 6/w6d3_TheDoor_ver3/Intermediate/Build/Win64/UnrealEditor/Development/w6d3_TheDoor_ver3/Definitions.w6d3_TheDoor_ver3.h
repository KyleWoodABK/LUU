...
#define UE_PROJECT_NAME w6d3_TheDoor_ver3
#define UE_TARGET_NAME w6d3_TheDoor_ver3Editor
#define UE_MODULE_NAME "w6d3_TheDoor_ver3"
...
#define W6D3_THEDOOR_VER3_API DLLEXPORT
